@extends('layouts.app', ['title' => 'Consultoria', 'page' => 'consultanty_service'])
        ...
        <div class="container">
            <div class="light-box p-3">
                <div class="breadcrumb">
                    <a href="{{ route('quoter') }}" class="goto-prev-link"><i class="bi bi-chevron-left"></i> VOLTAR</a>
                </div>
                ...
                <div class="light-box-body px-lg-5 pt-4 pb-5">
                    <div class="row">
                            ...
                            <a href="{{ url('consultoria-servico') }}">
                                <div class="quoter-consultancy quoter-item mx-xl-3">
                                    <div class="quoter-consultancy-content quoter-item-content">
                                        ...
                                        <div class="quoter-consultancy-body px-5 pt-3 pb-5">
                                            <h2>CONSULTORIA</h2>
                            ...
                            <a href="">
                                <div class="quoter-school quoter-item mx-xl-3">
                                    <div class="quoter-school-content quoter-item-content">
                                        ...
                                        <div class="quoter-school-body px-5 pt-3 pb-5">
                                            <h2>ESCOLA</h2>
