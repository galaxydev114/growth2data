            ...
            <div class="row gy-4">
                <div class="col-lg-3 col-md-4 col-sm-12 footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Soluções Digitais</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-12 footer-links">
                    <h4>Escola</h4>
                ...
                <div class="col-lg-3 col-md-12 footer-subscribe">
                    ...
                    <p>Inscreva-se para ficar por dentro das novidades do BLOG e muito mais sobre os mais diversos assuntos das áreas de Tecnologia da Informação.</p>
                    <div class="">
